...
public class DataInfo {
    ...
    public static final String yearBad[] = {"", "0", "AA", "$", "1", getYear(-1)};
    ...
    public static final String cVCRequiredToFill[] = {"Q", "$%&", ""};
    ...
    public static CardInfo getUserCardInfo(String str) {
        return new CardInfo(str, "01", getYear(1), faker.name().fullName(), faker.number().digits(3));
    }
    public static CardInfo getUserMonthInfo(String str) {
        return new CardInfo("1111 2222 3333 4444", str, getYear(1), faker.name().fullName(), faker.number().digits(3));
    }

    public static CardInfo getUserYearInfo(String str) {
        return new CardInfo("1111 2222 3333 4444", "01", str, faker.name().fullName(), faker.number().digits(3));
    }

    public static CardInfo getUserMonthYearInfo(int i) {
        return new CardInfo("1111 2222 3333 4444", getMonth(i), getYear(0), faker.name().fullName(), faker.number().digits(3));
    }

    public static CardInfo getUserFIOInfo(String str) {
        return new CardInfo("1111 2222 3333 4444", "12", getYear(1), str, faker.number().digits(3));
    }

    public static CardInfo getUserCVCInfo(String str) {
        return new CardInfo("1111 2222 3333 4444", "12", getYear(1), faker.name().fullName(), str);
    }
